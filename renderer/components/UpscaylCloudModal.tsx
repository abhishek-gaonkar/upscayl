          ...
          onSubmit={async (e) => {
            ...
            if (
              ...
              try {
                ...
                alert(t_infos("ALREADY_REGISTERED", { name }));
                return;
              }
              setName("");
              setEmail("");
              ...
              setShow(false);
              alert(t_infos("ADD_SUCCESS"));
            } else {
              alert(t_infos("INCORRECT_FIELDS"));
            }
          }}
        >
